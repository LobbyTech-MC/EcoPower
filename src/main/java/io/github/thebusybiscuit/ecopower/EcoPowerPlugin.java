...
public class EcoPowerPlugin extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        ItemStack categoryItem = new CustomItem(SlimefunUtils.getCustomHead("240775c3ad75763613f32f04986881bbe4eee4366d0c57f17f7c7514e2d0a77d"), "&2环保型发电机");
        Category category = new Category(new NamespacedKey(this, "generators"), categoryItem, 4);

        SlimefunItemStack rotor = new SlimefunItemStack("STEEL_ROTOR", "c51944b488e11cda65177d5911d651282b3012665e63b8929e1b6a4744b7ca8", "&b钢转子");
        ...
        SteamTurbine simpleTurbine = registerSteamTurbine(category, "STEAM_TURBINE", "aefd921cb61594324f3c09d7ac7d38185d2734333968f3ac38382cddf15f6d71", "&e简易蒸汽发电机", MachineTier.MEDIUM, 4, new ItemStack[] {
                null, rotor, null,
                SlimefunItems.STEEL_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.STEEL_INGOT,
                null, SlimefunItems.COPPER_WIRE, null
        });
        
        SteamTurbine advancedTurbine = registerSteamTurbine(category, "STEAM_TURBINE_2", "161aad79fb748bff1e6e94d4b6a5a277cc961c1a9abfe2a4ed88baab8a2b5971", "&c高级蒸汽发电机", MachineTier.ADVANCED, 6, new ItemStack[] {
                null, rotor, null,
        ...
        registerSteamTurbine(category, "STEAM_TURBINE_3", "b65e29a67860d82f66afe1060ec8a9ceacc8c7afe108f5d42f52ba854b0a62dc", "&4黑金刚石蒸汽发电机", MachineTier.END_GAME, 13, new ItemStack[] {
                null, rotor, null,
        ...
        WindTurbine simpleWindTurbine = registerWindTurbine(category, "WIND_TURBINE", "d23e4ce096e00eae6aba10d356b785c3fecc5aa3d7dad4a4a2a27ed7750df981", "&e简易风力发电机", MachineTier.MEDIUM, 5, new ItemStack[] {
                null, rotor, null,
                SlimefunItems.STEEL_THRUSTER, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.STEEL_THRUSTER,
                null, SlimefunItems.COPPER_WIRE, null
        });

        WindTurbine advancedWindTurbine = registerWindTurbine(category, "WIND_TURBINE_2", "2df9e595dbeac33f43b37dd4ffbc234ea0fa7c3f98aad77dc906ce5d6783c79d", "&c高级风力发电机", MachineTier.ADVANCED, 11, new ItemStack[] {
                null, rotor, null,
        ...
        registerWindTurbine(category, "WIND_TURBINE_3", "3fcef461b43f06ef9d58c94065bbf41b77a10050520b44082d5f66f6dbe71da0", "&4黑金刚石风力发电机", MachineTier.END_GAME, 23, new ItemStack[] {
        ...
        registerLightningReceptor(category, "LIGHTNING_RECEPTOR", "&e闪电收集器", 512, 8192, new ItemStack[] {
        ...
        LunarGenerator lunarGenerator = registerLunarGenerator(category, "LUNAR_GENERATOR", "&5月光发电机", 128, new ItemStack[] {
        ...
        SolarGenerator solarGenerator = registerHighEnergySolarGenerator(category, "HIGH_ENERGY_SOLAR_GENERATOR", "c4fe135c311f7086edcc5e6dbc4ef4b23f819fddaa42f827dac46e3574de2287", "&9高能太阳能发电机", 256, new ItemStack[] {
        ...
        registerSolarHelmet(category, "HIGH_ENERGY_SOLAR_HELMET", "&9高能太阳能头盔", 5, new ItemStack[] {
        ...
        registerHighEnergySolarGenerator(category, "RADIANT_SOLAR_GENERATOR", "240775c3ad75763613f32f04986881bbe4eee4366d0c57f17f7c7514e2d0a77d", "&9辐射太阳能发电机", 512, new ItemStack[] {
    ...
    private WindTurbine registerWindTurbine(Category category, String id, String texture, String name, MachineTier tier, int power, ItemStack[] recipe) {
        SlimefunItemStack turbineItem = new SlimefunItemStack(id, texture, name, "&7" + name + " 发电机的一部分");
        ...
        SlimefunItemStack multiblockItem = new SlimefunItemStack(id + "_MULTIBLOCK", texture, name + " 发电机", "", LoreBuilder.machine(tier, MachineType.GENERATOR), LoreBuilder.powerBuffer(0), LoreBuilder.powerPerSecond(power * 2));
    ...
    private LightningReceptor registerLightningReceptor(Category category, String id, String name, int min, int max, ItemStack[] recipe) {
        ...
        SlimefunItemStack item = new SlimefunItemStack(id, texture, name, "", "&f这台机器可以在雷暴天气时", "&f从雷击中收集能源", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.power(min, " - " + max + " J/次雷击"));
    ...
    private LunarGenerator registerLunarGenerator(Category category, String id, String name, int power, ItemStack[] recipe) {
        ...
        SlimefunItemStack item = new SlimefunItemStack(id, texture, name, "", "&f月光发电机只能在夜间工作!", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(0), LoreBuilder.powerPerSecond(power * 2));
    ...
    private HighEnergySolarGenerator registerHighEnergySolarGenerator(Category category, String id, String texture, String name, int power, ItemStack[] recipe) {
        SlimefunItemStack item = new SlimefunItemStack(id, texture, name, "", "&f太阳能发电机可以在任意时候工作!", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(0), LoreBuilder.powerPerSecond(power * 2));
    ...
    private SolarHelmet registerSolarHelmet(Category category, String id, String name, int power, ItemStack[] recipe) {
        SlimefunItemStack item = new SlimefunItemStack(id, Material.IRON_HELMET, name, "", "&f这个太阳能头盔可以为", "&f身上的装备和手持的物品充能", "", LoreBuilder.power(power, "/次充能"));
    ...
    public String getBugTrackerURL() {
        return "https://github.com/StarWishsama/EcoPower/issues";
    }
